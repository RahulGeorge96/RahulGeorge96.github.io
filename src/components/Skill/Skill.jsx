...
export default function Skill(props) {
  ...
  const skill = [
    ...
    { src: redux, title: "redux", id: 7 },
    { src: nodejs, title: "nodejs", id: 8 },
    { src: mongodb, title: "mongodb", id: 9 },
    { src: express, title: "express", id: 10 },
    // { src: mongoose, title: "mongoose", id: 11 },
    { src: git, title: "git", id: 11 },
    { src: npm, title: "npm", id: 12 },
    { src: materialui, title: "materialui", id: 13 },

    // { src: Next, title: "nextJs", id: 15 },
    { src: typeScript, title: "typeScript", id: 14 }
