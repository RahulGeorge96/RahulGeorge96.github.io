  ...
  return (
    <>
      <Box className="mainDiv" mt={["20%", "20%", "10%"]} ref={project}>
        <Box display="flex">
          <Heading fontSize={40} ml={["20%", "25%", "40%"]} mt="5%">
            Projects
          </Heading>
        </Box>
        ...
        >
          ...
          >
            ...
            >
              ...
              motorcycles and accessories, including helmets, gloves, and
              jackets.
            </Text>
            <Text mt={2} textAlign={"left"} fontSize={["14px", "14px", "17px"]}>
              {/* <b> Individual Project </b>| <b>Duration: </b> 04 Days */}
              <b> Group Project: </b>| 5 Collaborators | <b>Duration: </b> 05
              Days
            </Text>
          ...
          >
            ...
            <Text
              ...
              textAlign={"left"}
            >
              BeeHome is a real estate accommodation website that offers a
              variety of properties, including apartments, flats, and paying
              guest accommodations, helping users find and book their ideal
              living spaces easily.
            </Text>
            <Text mt={2} textAlign={"left"} fontSize={["14px", "14px", "17px"]}>
              <b> Group Project: </b>| 3 Collaborators | <b>Duration: </b> 05
              Days
            </Text>
            <Text mt={2} textAlign={"left"} fontSize={["13px", "13px", "15px"]}>
              <span style={{ color: "rgb(39, 116, 232)", fontSize: "16px" }}>
          ...
          >
            ...
            <Text mt={2} textAlign={"left"} fontSize={["14px", "14px", "17px"]}>
              <b> Group Project: </b>| 4 Collaborators | <b>Duration: </b> 05
              Days
            </Text>
            <Text mt={2} textAlign={"left"} fontSize={["13px", "13px", "15px"]}>
              <span style={{ color: "rgb(39, 116, 232)", fontSize: "16px" }}>
